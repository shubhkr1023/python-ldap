...
def create():
    if request.method == 'POST':
     try:
        ...
        mandatory=["username","role","displayName","organization","country","email","phone","mCode","password","managerEmailId"]
        ...
        if(len(missing_attr)==0): #i.e all mandatory fields are present in user input request body
                ...
                "title":data["fullname"],"description":data["role"],"managerid":data['managerDomainId'],
